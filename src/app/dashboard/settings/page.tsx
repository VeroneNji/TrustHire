    ...
    <div className="min-h-screen bg-[#F3F2F0]">
      ...
      <main className="md:pl-64 pt-16 md:pt-0">
        <header className="bg-white border-b border-gray-200 px-4 md:px-8 py-4 sticky top-0 z-20">
          <h1 className="text-lg md:text-xl font-bold text-[#0F172A] ml-12 md:ml-0">Settings & Privacy</h1>
        </header>

        <div className="max-w-3xl mx-auto p-4 md:p-8">p-8 grid grid-cols-12 gap-6">
